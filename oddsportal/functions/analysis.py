...
def analyzation(form_request):
    ...
    def analyze_teams(home_away_teams, results, recent_season_results, playing_at, stake_varying = None):
        ...
        def calc(handicap,
            ...
            def pl_fixed_calc(handicap, odd, varying_stake, profit_loss, full_win, half_win):
                if handicap == 'hda'
            ...
            # "stop after X loses"
                ...
                if waiting_for_win:
                    ...
                    profit_loss_value = pl_fixed_calc(handicap, odd, varying_stake, profit_loss, full_win, half_win)
                    waiting_for_win   = True if number_of_lost_games == number_of_games else False
                return (rofit_loss, round(profit_loss_value, 1), varying_stake, number_of_lost_games, waiting_for_win)
